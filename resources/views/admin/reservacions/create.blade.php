...
@section('javascript')
    ...
    <link href="{{asset('res/fonts.googleapis.com.css')}}" rel="stylesheet" type="text/css">
    <!-- Latest compiled and minified CSS -->
    
    <link href="{{asset('res/maxcdn.bootstrapcdn.com.css')}}" rel="stylesheet" type="text/css">
    <!-- Optional theme -->
    <link href="{{asset('res/maxcdn.bootstrapcdn.com2.css')}}" rel="stylesheet" type="text/css">

    <!-- Latest compiled and minified JavaScript -->


    <script src="{{asset('res/maxcdn.bootstrapcdn.com.bootstrap.min.js')}}"></script>

    <script src="{{asset('res/jquery-1.11.3.min.js')}}"></script>    
    ...
    <link rel="stylesheet" href="{{asset('res/jquery.timepicker.min.css')}}">
    <script src="{{asset('res/jquery.timepicker.min.js')}}"></script>
